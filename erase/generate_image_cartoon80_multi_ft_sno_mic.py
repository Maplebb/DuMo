...
def generate_images(sd_path, model_path1, model_path2, facilitate_factor, save_path, device='cuda:0', guidance_scale = 7.5, image_size=512, ddim_steps=100, num_samples=10, from_case=0, till_case=1000000, base='1.4'):
            ...
            for t in tqdm(scheduler.timesteps):
                ...
                with torch.no_grad():
                    ...
                    for i in range(len(down_block_res_samples)):
                        ...
                        down_block_res_samples[i] = down_block_res_samples[i] + down_block_res_samples2[i]
                    ...
                    # mid_block_res_sample3 *= used_multipliers[2]
                    mid_block_res_sample = mid_block_res_sample + mid_block_res_sample2
...
if __name__=='__main__':
    ...
    generate_images(sd_path=sd_path, model_path1=model_path1, model_path2=model_path2, facilitate_factor=facilitate_factor, save_path=save_path, device=device,
