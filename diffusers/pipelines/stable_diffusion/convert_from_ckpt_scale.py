...
def convert_ldm_unet_checkpoint(
    ...
    if controlnet:
        ...
        # time scale
        time_scale = unet_state_dict.pop("time_scale").cpu().numpy()
    ...
    return new_checkpoint, time_scale
...
def convert_controlnet_checkpoint(
    ...
    converted_ctrl_checkpoint, time_scale_numpy = convert_ldm_unet_checkpoint(
        checkpoint,
        ctrlnet_config,
    ...
    return controlnet, time_scale_numpy
...
def download_from_original_stable_diffusion_ckpt(
    ...
    path = checkpoint_path_or_dict if isinstance(checkpoint_path_or_dict, str) else ""
    converted_unet_checkpoint, time_scale_numpy = convert_ldm_unet_checkpoint(
...
def download_controlnet_from_original_ckpt(
    ...
    controlnet, time_scale_numpus = convert_controlnet_checkpoint(
        checkpoint,
        original_config,
        checkpoint_path,
        image_size,
    ...
    return controlnet, time_scale_numpus
